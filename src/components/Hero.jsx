...
import profilepic from "../assets/picture-profile.png";
    ...
    <div className="mt-24 max-w-[1000px] mx-auto relative">
        <div className="grid md:grid-cols-2 place-items-center gap-8">
            ...
            >
                ...
                >
                    HEY, I AM <br/>
                    <span className="text-purple-500 capitalize">Stephane monnier</span>
                </motion.p>
            ...
            <motion.img 
                src={profilepic}
                className="w-[300px] rounded-full md:w-[350px] bg-pink-400/10"
